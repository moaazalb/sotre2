...
const Navbar = () => {
  ...
  return (
    <>
      <div className="bg-gray-500 p-4 w-full flex justify-center items-center ">
        <p className="text-white font-inter text-2xl font-bold  ">
          Welcome <a className="text-white font-inter text-2xl font-bold  ">{name.charAt("0").toUpperCase() + name.slice(1)}</a> 
        </p>
      </div>
      ...
      <div className="bg-gray-500 p-4 w-full flex items-center justify-center mx-auto">
